...
def test_atari_make():
    ...
    env = atari_make("ALE/Freeway-v5", render_mode="rgb_array", atari_wrappers_dict=wrappers_dict)
    ...
    env2 = atari_make("ALE/Breakout-v5", render_mode="human", atari_wrappers_dict=wrappers_dict2)
