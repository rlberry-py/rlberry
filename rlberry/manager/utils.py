...
def tensorboard_to_dataframe(path_to_tensorboard_data):
    """
    Function to convert 'tensorboard log' to 'Panda DataFrames'. <br>
    ...
    The output format is a dictionary.
        ...
        | value = Panda DataFrame with the following structure (4 column): <br>
            - "name" = algo_name <br>
            - "n_simu" = n_simu (seed) <br>
            - "x" = step number <br>
            - "y" = value of the data <br>
