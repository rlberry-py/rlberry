...
.. video:: ../../example_atari_breakout_vectorized_ppo.mp4
   :width: 600

"""
# sphinx_gallery_thumbnail_path = 'thumbnails/example_atari_breakout_vectorized_ppo.jpg'
...
os.rename(
    ...
    "_video/example_atari_breakout_vectorized_ppo.mp4",
)
